...
//    }
    ...
    // Now that we have a song we can turn on the Export file menu option.
    if (document.getElementById('export-menu-option') !== null) {
      if (document.getElementById('export-menu-option').classList.contains('disabled')) {
        document.getElementById('export-menu-option').classList.toggle('disabled');
      }
    }
